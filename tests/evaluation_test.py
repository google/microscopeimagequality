...
class MiqEvalTest(tf.test.TestCase):
    ...
    def testAnnotatePatch(self):
        ...
        annotated_image = evaluation.annotate_patch(image, prediction=0, label=0)
        expected_image_width = (
            image_width * evaluation._IMAGE_ANNOTATION_MAGNIFICATION_PERCENT / 100)
        ...
        def check_image_matches_golden(prediction, label):
            annotated_image = evaluation.annotate_patch(
    ...
    def testAnnotateClassificationErrorsRuns(self):
        ...
        evaluation.annotate_classification_errors(images, predictions, labels,
    ...
    def testAnnotateClassificationErrorsRunsInTensorFlow(self):
        ...
        with g.as_default():
            ...
            labels = tf.zeros([self.batch_size, ])
            probabilities = tf.zeros([self.batch_size, num_classes])
            image, summary = evaluation.annotate_classification_errors(
    ...
    def testGetConfusionMatrix(self):
        ...
        confusion_matrix = evaluation.get_confusion_matrix(
    ...
    def testGetAggregatedPredictionTruePositive1(self):
        with self.test_session() as sess:
            ...
            prediction, label = evaluation.get_aggregated_prediction(probabilities,
                                                                     labels,
                                                                     self.batch_size)
    ...
    def testGetAggregatedPredictionRequiresIdenticalLabels(self):
        with self.test_session() as sess:
            ...
            _, label = evaluation.get_aggregated_prediction(probabilities, labels,
                                                            self.batch_size)
    ...
    def testGetRgbImageRuns(self):
        ...
        rgb_image = evaluation.get_rgb_image(
    ...
    def testAggregatePredictionFromProbabilities(self):
        ...
        (predicted_class, certainties, probabilities_averaged
         ) = evaluation.aggregate_prediction_from_probabilities(probabilities)
    ...
    def testAggregatePredictionFromProbabilitiesWithProduct(self):
        ...
        probabilities_aggregated = evaluation.aggregate_prediction_from_probabilities(
            probabilities, evaluation.METHOD_PRODUCT).probabilities
    ...
    def testAddRgbAnnotation(self):
        ...
        actual_rgb = (0, 1, 0)
        max_value = 1
        image_rgb = evaluation._add_rgb_annotation(image, predicted_rgb, actual_rgb,
                                                   max_value)
        image_expected = np.zeros((20, 20, 3))
        image_expected[0:evaluation.BORDER_SIZE, :, 1] = 1
        image_expected[-1 * evaluation.BORDER_SIZE:, :, 0] = 1
    ...
    def testApplyImageGamma(self):
        ...
        image_with_gamma = evaluation.apply_image_gamma(image, gamma=0.5)
    ...
    def testGetModelAndMetricsWithoutTrueLabels(self):
        ...
        with g.as_default():
            ...
            labels = evaluation.get_model_and_metrics(images, num_classes,
    ...
    def testSaveAndLoadResults(self):
        ...
        (aggregate_probabilities_2, aggregate_labels_2, certainties_2, orig_names_2,
         aggregate_predictions_2) = evaluation.load_inference_results(test_directory)
